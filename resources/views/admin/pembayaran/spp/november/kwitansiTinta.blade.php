...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0 align=left
 ...
 <tr style='height:20.65pt'>
  ...
  normal'><span lang=IN style='font-size:10.0pt'>{{$november->santri->no_pend}}</span><b><span
  style='font-size:10.0pt;font-family:"Arial Black","sans-serif"'> / </span></b><span style='font-size:10.0pt'><br>{{$november->santri->id_santri}}</span></p>
  </td>
 </tr>
 <tr style='height:28.0pt'>
  ...
  lang=IN style='font-size:8.0pt'>{{$november->santri->nama_santri}}</span></p>
  </td>
 </tr>
 <tr style='height:34.75pt'>
  ...
  <p class=MsoNoSpacing><span
  lang=IN style='font-size:10.0pt'>{{$november->administrasi->nama_administrasi}}</span></p>
  </td>
 </tr>
 ...
 <tr style='height:22.8pt'>
  ...
  lang=IN>Rp.{{number_format($november->nominal)}}</span></p>
  </td>
 </tr>
 <tr style='height:36.85pt'>
  ...
  <p class=MsoNoSpacing><span style='font-size:11.0pt'>R.{{$november->id}}</span><span
  lang=IN style='font-size:11.0pt'><br>{{$november->administrasi->nama_administrasi}}</span></p>

  <p class=MsoNoSpacing align=left style='text-align:left'><span
  lang=IN style='font-size:11.0pt'>{{$november->waktu}}</span></p>
  </td>
 </tr>
</table>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0 align=left
 ...
 <tr style='height:21.15pt'>
  ...
  <p class=MsoNoSpacing><span
  lang=IN style='font-size:10.0pt'>{{$november->santri->no_pend}}</span><b><span
  style='font-size:10.0pt;font-family:"Arial Black","sans-serif"'> / </span></b><span style='font-size:10.0pt'>{{$november->santri->id_santri}}</span></p>
  </td>
 </tr>
 <tr style='height:17.0pt'>
  ...
  <p class=MsoNoSpacing><span lang=IN><b>{{$november->santri->nama_santri}}</b></span></p>
  </td>
 </tr>
 <tr style='height:22.7pt'>
  ...
  <p class=MsoNoSpacing><b>{{number_format($november->nominal)}}</b></p>
  </td>
 </tr>
 <tr style='height:17.0pt'>
  <td width=340 colspan=2 valign=bottom style='width:9.0cm;border-top:none;
  border-left:none;border-bottom:solid #D9D9D9 1.0pt;border-right:solid #D9D9D9 1.0pt;
  padding:0cm 5.4pt 0cm 5.4pt;height:17.0pt'>
  <p class=MsoNoSpacing><b>{{$november->administrasi->nama_administrasi}}</b></p>
  </td>
 </tr>
 ...
 <tr style='height:12pt'>
  ...
  border-top:none;padding:0cm 5.4pt 0cm 5.4pt;height:12.1pt'>
  <p class=MsoNoSpacing align=center style='text-align:center'><span
  lang=IN><b>{{$november->status}}</b></span></p>
  </td>
  ...
  <p class=MsoNoSpacing align=right style='text-align:right'>Ketapang,<span lang=IN>{{$november->waktu}}</span></p>
  </td>
 </tr>
 ...
 <tr style='height:20pt'>
  ...
  <p class=MsoNoSpacing align=center style='text-align:center'><span
  lang=IN style='font-size:16.0pt'><b>Rp.{{number_format($november->nominal)}}</b></span></p>
  </td>
  <td width=198 valign=bottom style='width:148.8pt;border-top:none;border-left:
  none;border-bottom:solid #D9D9D9 1.0pt;border-right:solid #D9D9D9 1.0pt;
...
<a href="{{url('admin/november')}}"><< kembali</a>