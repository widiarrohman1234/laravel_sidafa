		...
		<div class="col-md-12 mt-5">
			<div class="card">
				<div class="card-header">
					Tambah Data SPP maret
				</div>
				<div class="card-body">
					<form action="{{url('admin/maret')}}" method="post">
						@csrf
					<div class="form-row">	
						<div class="form-group col-md-6">
		                  ...
		                  <select name="id_santri" class="form-control select2" style="width: 100%;">
		                  	...
		                  	@foreach($list_santri as $maret)
			                    <option value="{{$maret->id}}">{{$maret->id_santri}}-{{$maret->nama_santri}}-> {{$maret->sts_ads_spp}}</option>
		                    @endforeach
		                  </select>
		                </div>		
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							...
							<input type="text" name="id_administrasi" class="form-control" value="3" readonly>
							<input type="text" name="" class="form-control" value="sppmaret" readonly>
						</div>	
