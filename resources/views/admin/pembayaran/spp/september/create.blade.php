		...
		<div class="col-md-12 mt-5">
			<div class="card">
				<div class="card-header">
					Tambah Data SPP september
				</div>
				<div class="card-body">
					<form action="{{url('admin/september')}}" method="post">
						@csrf
					<div class="form-row">	
						<div class="form-group col-md-6">
		                  ...
		                  <select name="id_santri" class="form-control select2" style="width: 100%;">
		                  	...
		                  	@foreach($list_santri as $september)
			                    <option value="{{$september->id}}">{{$september->id_santri}}-{{$september->nama_santri}}-> {{$september->sts_ads_spp}}</option>
		                    @endforeach
		                  </select>
		                </div>		
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							...
							<input type="text" name="id_administrasi" class="form-control" value="9" readonly>
							<input type="text" name="" class="form-control" value="sppseptember" readonly>
						</div>	
