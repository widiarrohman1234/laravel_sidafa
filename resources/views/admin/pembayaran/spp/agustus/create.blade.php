		...
		<div class="col-md-12 mt-5">
			<div class="card">
				<div class="card-header">
					Tambah Data SPP agustus
				</div>
				<div class="card-body">
					<form action="{{url('admin/agustus')}}" method="post">
						@csrf
					<div class="form-row">	
						<div class="form-group col-md-6">
		                  ...
		                  <select name="id_santri" class="form-control select2" style="width: 100%;">
		                  	...
		                  	@foreach($list_santri as $agustus)
			                    <option value="{{$agustus->id}}">{{$agustus->id_santri}}-{{$agustus->nama_santri}}-> {{$agustus->sts_ads_spp}}</option>
		                    @endforeach
		                  </select>
		                </div>		
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							...
							<input type="text" name="" class="form-control" value="sppagustus" readonly>
						</div>	
