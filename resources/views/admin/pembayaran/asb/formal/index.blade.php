...
<div class="tab-content" id="nav-tabContent">
	...
	<a href="{{url('admin/administrasisantribaruformal/create')}}" class="btn btn-dark float-right"><i class="fa fa-plus"></i> Tambah</a>
	<div class="card-body">
	<table class="table table-datatable">
		...
		<tbody>
		@foreach($list_administrasi_santri_baru_a as $administrasisantribaru)
		 <tr>
			...
			<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
			  <div class="btn-group" role="group">
			    ...
			    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
			      <a class="dropdown-item" href="{{url('admin/administrasisantribaru/kwitansiThermo', $administrasisantribaru->id)}}">Print Thermo (58mm)</a>
			      <a class="dropdown-item" href="#" >Print Thermo (80mm)</a>
			      <a class="dropdown-item" href="{{url('admin/administrasisantribaru/kwitansiTinta', $administrasisantribaru->id)}}" >Print Tinta</a>
			    </div>
			  </div>
			</div>

			<div class="btn-group">
			<a href="{{url('admin/administrasisantribaru', $administrasisantribaru->id)}}" class="btn btn-dark float-right"><i class="fa fa-info"></i></a>
			<a href="{{url('admin/administrasisantribaru', $administrasisantribaru->id)}}/edit" class="btn btn-warning float-right"><i class="fa fa-edit"></i></a>
			@include('admin.template.utils.delete', ['url' => url('admin/administrasisantribaru', $administrasisantribaru->id)])
			</div>
			</td>
