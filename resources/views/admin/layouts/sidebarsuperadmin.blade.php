            ...
            <ul class="nav nav-treeview">
              <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="{{url('admin/administrasisantribarupondok')}}" class="nav-link {{checkrouteactive('admin/administrasisantribaru')}}">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Pondok</p>
                    </a>
                  </li>
                  ...
                  <li class="nav-item">
                    <a href="{{url('admin/administrasisantribaruformal')}}" class="nav-link {{checkrouteactive('admin/administrasiformal')}}">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Formal</p>
                    </a>
                  </li>
