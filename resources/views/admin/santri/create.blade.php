	                ...
	                <form class="form-horizontal" action="{{url('admin/santri')}}" method="post">
	                    	...
	                    	<div class="row">
	                    			...
	                    			<div class="form-group row">
									  <div class="col-sm-12">
									    <input type="name" class="form-control" name="id_santri" placeholder="1114001">
									  </div>
									</div>
	                    			...
	                    			<div class="form-group row">
									  <div class="col-sm-12">
									    <input type="name" class="form-control" name="no_pend" placeholder="SMA11-01-ASB21">
									  </div>
									</div>
	                    	</div>
	                    	...
	                    	<div class="row">
								...
								<div class="form-group row">
								  <div class="col-sm-12">
								    <input type="name" class="form-control" name="nik" placeholder="6104160909010007">
								  </div>
								</div>
								...
								<div class="form-group row">
								  <div class="col-sm-12">
								    <input type="name" class="form-control" name="no_kk">
								  </div>
								</div>
	                    	</div>
							  ...
							  <div class="col-sm-10">
							    <input type="name" class="form-control" name="nama_santri" placeholder="Muhammad Widi Arrohman">
							  </div>
							</div>
							  ...
							  <div class="col-sm-10">
				                ...
				                <input type="checkbox" name="sts_santri" value="aktif" value="alumni" checked data-bootstrap-switch data-off-color="danger" data-on-color="success">
							  </div>
							</div>
							...
							<div class="form-group row">
							  ...
							  <div class="col-sm-2">
							    <input type="name" class="form-control" name="ta">
							  </div>
							  <label for="inputName" class="col-sm-1 col-form-label">Kamar</label>
							  <div class="col-sm-1">
							    <input type="name" class="form-control" name="kmr">
							  </div>
							</div>
							...
							<div class="row">
								  ...
								  <div class="col-sm-6">
								    <input type="name" class="form-control" name="tpt_lhr_santri">
								  </div>
								</div>
								  ...
								  <div class="col-sm-6">
								    <input type="date" class="form-control" name="tgl_lhr_santri">
								  </div>
								</div>
							</div>
							...
							<div class="form-group row">
							  ...
							  <div class="col-sm-1">
							    <input type="name" class="form-control" name="rt">
							  </div>
							  /
							  	<label for="inputName" class="col-sm-1 col-form-label">Rw</label>
							  <div class="col-sm-1">
							    <input type="name" class="form-control" name="rw">
							  </div>
							</div>
							...
							<div class="form-group row">
							  ...
							  <div class="col-sm-4">
							    <input type="name" class="form-control" name="des_kel">
							  </div>

							  <label for="inputName" class="col-sm-2 col-form-label">Kecamatan</label>
							  <div class="col-sm-4">
							    <input type="name" class="form-control" name="kec">
							  </div>
							</div>
							...
							<div class="form-group row">
							  ...
							  <div class="col-sm-3">
							    <input type="name" class="form-control" name="kab_kota">
							  </div>

							  <label for="inputName" class="col-sm-2 col-form-label">Provinsi</label>
							  <div class="col-sm-5">
							    <input type="name" class="form-control" name="prov">
							  </div>
							</div>
	                  </div>
	                  <!-- /.tab-pane -->
	                ...
	                <!-- administrasi -->
	                      ...
	                      <div class="form-group row">
	                        ...
	                        <div class="col-sm-10">
	                          ...
	                          <select class="form-control" name="sts_ads_ssmp">
	                          	<option value="">-SERAGAM SMP-</option>
	                          	<option value="ya">ya</option>
	                          	<option value="tidak">tidak</option>
	                         </select>
	                        </div>
	                      ...
	                      <div class="form-group row">
	                        ...
	                        <div class="col-sm-10">
	                          ...
	                          <select class="form-control" name="sts_ads_ssma">
	                          	<option value="">-SERAGAM SMA-</option>
	                          	<option value="ya">ya</option>
	                          	<option value="tidak">tidak</option>
	                         </select>
	                        </div>
	                      ...
	                      <div class="form-group row">
	                        ...
	                        <div class="col-sm-10">
	                          ...
	                          <select class="form-control" name="sts_ads_rsma">
	                          	<option value="">-RAPORT SMA-</option>
	                          	<option value="ya">ya</option>
	                          	<option value="tidak">tidak</option>
	                         </select>
	                        </div>
	                  ...
	                  <div class="tab-pane" id="ayah">
	                      ...
	                      <div class="form-group row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="name" class="form-control" name="nm_ayah" placeholder="Name">
	                        </div>
	                      </div>
	                      ...
	                      <div class="form-group row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="date" class="form-control" name="tgl_lhr_ayah">
	                        </div>
	                      </div>
	                      <div class="form-group row">
	                        <label for="inputName" class="col-sm-10 col-form-label">Tempat Lahir ayah</label>
	                        <div class="col-sm-10">
	                          <input type="name" class="form-control" name="tpt_lhr_ayah">
	                        </div>
	                      </div>
	                  	</div>
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="name" class="form-control" name="alamat_ayah">
	                        </div>
	                      </div>
	                      ...
	                      <div class="form-group row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="name" class="form-control" name="no_hp_ayah">
	                        </div>
	                      </div>
	                    </div>
	                      ...
	                      <div class="row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="name" class="form-control" name="pkj_ayah">
	                        </div>
	                      </div>
	                      ...
	                      <div class="form-group row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="name" class="form-control" name="penghasilan_ayah">
	                        </div>
	                      </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="tab-pane" id="ibu">
	                      ...
	                      <div class="form-group row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="name" class="form-control" name="nm_ibu" placeholder="Name">
	                        </div>
	                      </div>
	                      ...
	                      <div class="form-group row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="date" class="form-control" name="tgl_lhr_ibu">
	                        </div>
	                      </div>
	                      <div class="form-group row">
	                        <label for="inputName" class="col-sm-10 col-form-label">Tempat Lahir ibu</label>
	                        <div class="col-sm-10">
	                          <input type="name" class="form-control" name="tpt_lhr_ibu">
	                        </div>
	                      </div>
	                  	</div>
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="name" class="form-control" name="alamat_ibu">
	                        </div>
	                      </div>
	                      ...
	                      <div class="form-group row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="name" class="form-control" name="no_hp_ibu">
	                        </div>
	                      </div>
	                    </div>
	                      ...
	                      <div class="row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="name" class="form-control" name="pkj_ibu">
	                        </div>
	                      </div>
	                      ...
	                      <div class="form-group row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="name" class="form-control" name="penghasilan_ibu">
	                        </div>
	                      </div>
	                      </div>
	                  </div>
	                  ...
	                  <div class="tab-pane" id="wali">
	                      ...
	                      <div class="form-group row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="name" class="form-control" name="nm_wali" placeholder="Name">
	                        </div>
	                      </div>
	                      ...
	                      <div class="form-group row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="date" class="form-control" name="tgl_lhr_wali">
	                        </div>
	                      </div>
	                      <div class="form-group row">
	                        <label for="inputName" class="col-sm-10 col-form-label">Tempat Lahir wali</label>
	                        <div class="col-sm-10">
	                          <input type="name" class="form-control" name="tpt_lhr_wali">
	                        </div>
	                      </div>
	                  	</div>
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="name" class="form-control" name="alamat_wali">
	                        </div>
	                      </div>
	                      ...
	                      <div class="form-group row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="name" class="form-control" name="no_hp_wali">
	                        </div>
	                      </div>
	                    </div>
	                      ...
	                      <div class="row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="name" class="form-control" name="pkj_wali">
	                        </div>
	                      </div>
	                      ...
	                      <div class="form-group row">
	                        ...
	                        <div class="col-sm-10">
	                          <input type="name" class="form-control" name="penghasilan_wali">
	                        </div>
	                      </div>
	                      </div>
