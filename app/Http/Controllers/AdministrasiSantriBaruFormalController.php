...
class AdministrasiSantriBaruFormalController extends Controller
{
        function index(){
         $data['list_administrasi_santri_baru_a'] =  DB::table('administrasi_santri_baru')
            ...
            ->whereIn ('ket',['formal','formal-putra'])
            ->groupBy ('administrasi_santri_baru.id')
            ->get();
            //dd($data['list_administrasi_santri_baru']);
        return view('admin.pembayaran.asb.formal.index', $data);
    }
    ...
    function store()
    {
        ...
        return redirect('admin/administrasisantribaruformal')->with('success','Data Berhasil Ditambahkan');
    }
    ...
    function update(AdministrasiSantriBaru $administrasisantribaru)
    {
        ...
        return redirect('admin/administrasisantribaruformal')->with('success','Data Berhasil Diubah');
    }

    function destroy(AdministrasiSantriBaru $administrasisantribaru)
    {
        $administrasisantribaru->delete();
        return redirect('admin/administrasisantribaru')->with('danger','Data Berhasil Dihapus');
    }
